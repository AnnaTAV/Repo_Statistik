...
# Пусть - количество студентов на факультете A, тогда на факультете B учится n студентов, а на факультете C2n студентов.
# Введем события S(A), S(B), S(C), что сессию сдаёт студент факультетов A, B, и С соответственно, и событие D-сессия сдана.
